...
/**
 * Provides necessary meta information about the bookstorecore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class BookstoreCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(BookstoreCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "my.bookstore.core.hmc.locales";
